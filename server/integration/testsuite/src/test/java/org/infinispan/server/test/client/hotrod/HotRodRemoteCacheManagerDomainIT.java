...
import org.infinispan.server.test.category.HotRodDomain;
...
@Category({ HotRodDomain.class, HotRodClusteredDomain.class, Smoke.class })
public class HotRodRemoteCacheManagerDomainIT extends AbstractRemoteCacheManagerIT {
    ...
    public static void beforeClass() throws Exception {
        ...
        if (isDistributedMode()) {
            ...
            testCache = "cmLocalTestCache";
            client.addLocalCache(testCache, "default", "default");
        } else {
