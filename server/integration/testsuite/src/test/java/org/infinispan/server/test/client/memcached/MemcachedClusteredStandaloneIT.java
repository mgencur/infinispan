...
import org.infinispan.server.test.category.MemcachedClusteredStandalone;
...
@Category({ MemcachedClusteredStandalone.class, Smoke.class })
public class MemcachedClusteredStandaloneIT extends AbstractClusteredMemcachedIT {
