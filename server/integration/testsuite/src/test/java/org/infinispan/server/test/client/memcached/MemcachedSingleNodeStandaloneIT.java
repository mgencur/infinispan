...
import org.infinispan.server.test.category.MemcachedStandalone;
...
@Category({ MemcachedStandalone.class })
public class MemcachedSingleNodeStandaloneIT extends AbstractSingleNodeMemcachedIT {
